...
def test_downgrade(base_app, database):
    ...
    alembic.stamp(target="f563233434cd")
    # Skip 42a5817ca169 as it's only removing FK which should be on QA, prod and not on local test env.
...
def test_upgrade(base_app, database):
    ...
    # but skip 42a5817ca169
    alembic.downgrade(target="42a5817ca169")
    alembic.stamp(target="f563233434cd")
